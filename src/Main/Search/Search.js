        ...
        <div className='container-fluid search d-flex justify-content-center align-items-center' style={{ backgroundImage: `url(${searchBackground})` }}>
            <div>
                ...
                <div className="input-group mt-2 ms-3">
                    <input id="input-field" type="text" className="form-control rounded-pill" placeholder="Search food items"
                        aria-label="Recipient's username" aria-describedby="button-addon2" />
                    <button className="btn px-4 rounded-pill search-btn" type="button"
